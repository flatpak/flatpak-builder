...
- GitHub private [vulnerability issues](https://github.com/flatpak/flatpak-builder/security/advisories/new) (preferred), or,
- Email to the
private mailing list [flatpak-security@lists.freedesktop.org](mailto:flatpak-security@lists.freedesktop.org) (alternative). You can request to join the list [here](https://lists.freedesktop.org/mailman/listinfo/flatpak). Emails should be forwarded to GitHub private security issues by the list maintainers.
...
There shall be no exceptions to this process and the maintainer(s) decision
is final.
